...
console.log("Before DemoLoadBalancing");
Meteor.DemoLoadBalancing = (function (_super) {
    __extends(DemoLoadBalancing, _super);
    function DemoLoadBalancing() {
    	var ParticleDemoMasterAddress = "app-us.exitgamescloud.com:9090";
    	var ParticleDemoAppId = "0149e21c-033f-4074-95ac-e32d4b6131a4";
    	var ParticleDemoAppVersion = "1.0";
        _super.call(this, ParticleDemoMasterAddress, ParticleDemoAppId, ParticleDemoAppVersion);
        this.logger = new Meteor.Exitgames.Common.Logger("Demo: ");
        this.USERCOLORS = [
            "#FF0000", 
            "#00AA00", 
            "#0000FF", 
        ...
        this.setLogLevel(Meteor.Exitgames.Common.Logger.Level.DEBUG);
    ...
    DemoLoadBalancing.prototype.onStateChange = function (state) {
        ...
        this.logger.info("Damir: onStateChange");
        var LBC = Meteor.photon.LoadBalancing.LoadBalancingClient;
...
})(Meteor.photon.LoadBalancing.LoadBalancingClient);